...
---
**※Zotero와 iCloud를 연동하기 위해서는** **Zotero6****를 설치해야 한다.**
...
A. Zotero에서 Add-ons Manager 실행 (Zotero 실행 > 도구 (Tools) > 확장기능 (Add-ons))
...
B. Add-ons Manager에서 Zotfile 설치 (우측 상단 톱니바퀴 > install Add-on From File)
